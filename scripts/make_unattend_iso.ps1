# Original code from https://github.com/StefanScherer/packer-windows/blob/f02b1acbac56e6e1ae85ae8d88ed56dfd1af0849/make_unattend_iso.ps1
...
$isoList = @(   
    @{
        FileName = "./iso/windows_10_1809_unattend.iso";
        Files    = @(
            "./answer_files/10-1809/autounattend.xml",
